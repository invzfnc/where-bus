                        ...
                        <div key={stop.id} ref={isSelected ? selectedRowRef : null}>
                          ...
                          <button
                            ...
                            className={`w-full text-left rounded-2xl px-3 py-2.5 transition-all duration-150 border ${
                              isSelected
                                ? 'bg-gray-100 dark:bg-[var(--accent-dim)] border-gray-300 dark:border-[var(--border-card)] border-l-4 dark:shadow-[0_0_0_1px_var(--accent-glow)]'
                          ...
                          <div className="flex gap-1 ml-2 shrink-0">
                            {route.servesOutbound && (
                              <span className="text-xs rounded-full px-2 py-0.5" style={isDarkMode
                                ? { backgroundColor: '#F9731618', color: '#F97316' }
